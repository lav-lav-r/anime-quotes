...
<div bind:this={quote} transition:slide="{{delay: 250, duration: 300, easing: quintOut}}" class="quote-container">
  <blockquote id="text">
    ...
    There is nothing permanent except change.</blockquote>
  <p id="author">Heraclitus</p>
</div>
{/if}

<div class="icon-container">
  <button class="ani-shake">
    <a id="tweet-quote" target="_blank" href="https://twitter.com/intent/tweet?hashtags=quotes"> <!-- Add LINK to Twitter -->
